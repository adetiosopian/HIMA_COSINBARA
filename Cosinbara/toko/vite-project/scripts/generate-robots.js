 ...
 * @param {string} options.siteUrl - Domain website (misal: https://sinstore.himacosinbara.com)
...
export function generateRobotsTxt({
  ...
  if (!siteUrl) {
    throw new Error('❌ siteUrl wajib diisi, misalnya: https://sinstore.himacosinbara.com')
  }
