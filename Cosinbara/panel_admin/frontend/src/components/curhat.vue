...
<template>
    ...
    <div class="p-5 mt-[18px]">
      ...
      <div :class="tampil" v-for="(item, i) in pesanList" :key="i" class="p-2 border-b border-gray-600">
        <p class="text-gray-500">{{ item.pesan }}</p>
        <small class="text-gray-400">{{ item.waktu }}</small>
      </div>
    </div>
</template>
